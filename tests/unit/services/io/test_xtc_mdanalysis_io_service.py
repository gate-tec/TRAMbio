...
from TRAMbio.services import IOServiceRegistry, StructureServiceRegistry, ParameterRegistry
...
class TestRead(TestMockService, TestParameters):
    ...
    def test_empty_stride_50(self, mock_services_empty, path_trajectory_sample, parameters_xtc_mdanalysis_no_hydrogen_test):
    ...
    @pytest.mark.requires_MDAnalysis
    def test_empty_stride_1(self, mock_services_empty, path_trajectory_sample, parameters_xtc_mdanalysis_no_hydrogen_test):
        xtc_io_service = IOServiceRegistry.XTC.query_service(self.TESTED_SERVICE)
        callback_function = mock_services_empty
